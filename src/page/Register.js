      ...
      <div className="w-1/3 h-2/3 bg-white shadow-2xl rounded-lg flex justify-center items-center ">
        <div className="w-2/3 h-2/3 p-4 ">
          ...
          <form onSubmit={handleLogin}>
            <div className="my-5">
              <p className="font-roboto font-normal font-400 text-base leading-5 text-gray-700 pb-2">
                Username
              </p>
              <input
            ...
            <button
              className="bg-orange-500 rounded-lg font-roboto font-bold font-700 text-lg leading-6 text-white w-full h-12"
              type="submit"
            >
              เข้าสู่ระบบ
            </button>
